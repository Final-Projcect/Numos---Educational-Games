        ...
        if (collision.gameObject.tag == foodjar)
            {
                ...
                if (alredyrabbitinhand == true)
                {
                    ...
                    if (jarrabbit < 2 && inthejar == false)
                        ...
                        textdisplay.text = "מעולה, עכשיו תוכלו להוסיף עוד כמה חרפוג'יי מערות על מנת שיהיו לנו ארבעה חרפוג'ים בקערה, ככה נמנמי הכוח יזיזו עבורנו את האבן החוסמת?? ??";
                        nextfive = true;
                        inthejar = true;
                        }
                        ...
                        if (nextfive == true)
                        {
                           ...
                           if (jarrabbit == 5)
                          {
                            textdisplay.text = "כל הכבוד! יש לנו חמש חרפוג'ים בתוך הקערה, על מנת לצאת מהמערה עליכם לדרוך על הלבנים המעופפות ולהעביר אבנים למקומם על ציר המספרים החיוביים שליליים.";
                            Destroy(firstsix);
                            Destroy(block);
                            Instantiate(sixchar);
                            alradyon = true;
